    ...
    <div className="flex w-full" >
      <Dialog open={isOpen} onOpenChange={(open) => {
        ...
        <DialogTrigger asChild>
          <div className="flex flex-col w-full rounded-xl p-3 bg-[linear-gradient(to_right,_#134e5e,_#71b280)] min-h-52 transform transition-transform ">
            <div className="flex justify-between h-1/4 ">
              <h3 className="text-xl text-white roboto">{title}</h3>
              <div className="w-[30px] h-[30px] rounded-full bg-[#0e1426] p-1 text-white">
                {icon}
              </div>
            </div>
            ...
            <div className="flex flex-col h-1/4">
              <div className="w-full h-[2px] bg-gradient-to-r from-transparent via-[#0d1220] to-transparent"></div>
              <div className="flex justify-between items-center mt-2">
                {texts.map((text, index) => (
                  <p key={index} className="text-[#1a1f2b]">
                    {text}
                  </p>
                ))}
              </div>
